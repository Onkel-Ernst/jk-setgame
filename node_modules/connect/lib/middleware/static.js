...
/*JK*///, mime = require('mime');
/*JK*/	, mime = require('mime-types');
...
//*JK230819*/ root = 'D:\\JK\\dev\\setgame-master';
 /*JK230819*/ root = '/';
              options.root = root;
/*JK*/
//path ="./";
//path ="public";
  console.log( "\n---------- connect\\lib\\middleware\\static.js: 130" 
...
//JK  path = join(options.root, path);
  ...
  console.log( "\n---------- connect\\lib\\middleware\\static.js: 144" 
           + "\n  mime.lookup: " + type
           + "\n  path: " + path
           + "\n  fn: " + fn
           );
  ...
  fs.stat(path, function(err, stat){
    ...
    // transfer
    console.log( "\n---------- connect\\lib\\middleware\\static.js: 205" 
           + "\n  setHeader: " + type
           + "\n  bytes: " + stat.size 
           );
