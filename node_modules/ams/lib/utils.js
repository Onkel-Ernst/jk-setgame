...
exports.mkdirSync = function(path, mode) {
   ...
   path.split('/').forEach(function(name) {
       ...
       try {
           ...
           /*JK*/ //n.fs.exports.mkdirSync(curesolvedPath, mode || 511);
           /*JK*/ //exports.mkdirSync(curesolvedPath, mode || 511);
           /*JK*/console.log('---------- ams\\lib\\util.js: TODO - make a dir: ' + curesolvedPath);
       }
