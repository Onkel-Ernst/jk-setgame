    ...
    paths.forEach(function(path) {
        if ((!o.filter || !o.filter.test(path)) &&
            (!o.pattern || o.pattern.test(path))) {
                this.data[path] = /*JK*//*n.*/fs.readFileSync(path);
            }
    }, this);
...
/*JK*/
console.log( "\n__________ add: ams\\lib\\build.js: 120" 
           //+ "\n  n: " + n 
           + "\n  n: " + n + " stringify: " + JSON.stringify(n)
           + "\n  __dirname: " + __dirname 
           //+ "\n  targetDir: " + targetDir 
           //+ "\n  n.path: " + n.path 
           + "\n  path: " + path 
...
/***
    ...
    if (path.substr(0, 1) !== '/') {
        ...
        //path = n.path.join(__dirname, path);
        path = process.cwd();
    }
***/
...
/*JK*/  //targetDir = n.path.join(process.cwd(), targetDir);
/*JK*/  //targetDir = n.path.join("JK/dev/setgame-master", targetDir);
...
/*JK*///this.data[targetPath] = /*n.*/fs.readFileSync(path);
    this.data[targetPath] = path;

/*JK*/
console.log( "\n__________ add: ams\\lib\\build.js: 158" 
           + "\n targetDir: " + targetDir 
...
/*JK*/
console.log( "\n__________ process: ams\\lib\\build.js: 180" 
           + "\n path: " + path 
           );
            opts.call(
                this,
...
proto.combine = function(opts) {
    ...
    for (ext in o) {
        ...
        for (path in this.data) {
/*JK*/
console.log( "\n__________ combine: ams\\lib\\build.js: 241" 
           + "\n path: " + path 
           );
            if (regex.test(path)) {
...
/*JK*/  //targetPath = n.path.join(targetRoot, targetPath);

/*JK*/  //utils.mkdirSync(n.path.dirname(targetPath));
/*JK*/  utils.mkdirSync(targetPath);
console.log( "\n---------- write: ams\\lib\\build.js: 304" 
           + "\n  targetPath: " + targetPath 
           + "\n  path: " + path 
           + "\n  this.data[path]:" + this.data[path]
           );

/*JK*/  /*n.*/fs.writeFileSync(targetPath, this.data[path]);
    }
...
/*JK*///n.util.log(msg || 'Build was successfull.');
      console.log(msg || 'end: ams\\lib\\build.js: 324\nBuild was successfull.');
      return this;
};
